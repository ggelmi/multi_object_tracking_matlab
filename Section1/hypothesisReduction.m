classdef hypothesisReduction
    ...
    methods (Static)
        function [hypothesesWeight, multiHypotheses] = ...
            ...
            %       1 structure  
            hypothesesWeight= hypothesesWeight(hypothesesWeight >threshold);
            multiHypotheses = multiHypotheses( hypothesesWeight >threshold);
        ...
        function [hypothesesWeight, multiHypotheses] = ...
            ...
            %       1 structure 
            [newHypos,Index] = sort(hypothesesWeight,'descend');
            multiHypotheses = multiHypotheses(Index);
            M = min(M,length(hypothesesWeight));
            multiHypotheses = multiHypotheses(1:M);
            hypothesesWeight = newHypos(1:M);
